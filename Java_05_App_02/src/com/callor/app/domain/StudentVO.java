...
public class StudentVO {
	 ...
	 * 
	 * JDK를 사용하여 프로젝트를 수행 할 때
	 * 다양한 도구들을 연결 할 필요가 있는데
	 ...
	 * 다양한 JDK 도구를 사용 할 때는 필요하기도 하므로
	 * 표준 Java 코딩의 VO 클래스 작성 패턴에서는
	 * 모든 변수는 private 으로 선언하고 getter, setter를 정의해 준다
	 */
	...
	/*
	 * 클래스 정의 (class prototype define) Java 파일을 생성하고 class 키워드를 시작으로 만든 코드
	 */
	...
	/*
	 * VO 객체에 데이터를 저장한 후 저장된 데이터가 잘 담겼는지 확인하는 용도로 사용하기 위하여 toString() method를 재정의 한다
	 */
