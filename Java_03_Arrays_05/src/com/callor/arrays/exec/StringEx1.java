...
public class StringEx1 {
	...
	public static void main(String[] args) {
		/*
		 * 문자열형 변수는 숫자형, boolean형 변수와 저장 방식이 다르다 그렇기 때문에 문자열형 변수에 저장된 문자열을 EQ(==) 비교를 하는
		 * 것은 매우 위험한 코드다 문자열형 변수는 절대 EQ 또는 Not EQ(!=)를 사용하여 비교하지 않는다
		 */
		...
		// 아래의 코드를 Chaining을 사용하여 한 문장으로 완성하기
		...
		// 대소문자를 무시하고 문자열 비교(띄어쓰기는 무시하지 않음)
